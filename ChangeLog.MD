...
- Missing RECURSIVE on vector clear() method.   This can be a problem
  in some use cases (yaFyaml) involving recursive data structures such
  as sequence-of-sequence.
